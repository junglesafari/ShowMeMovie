...
public class adaptortvdone extends RecyclerView.Adapter<viewholderforrecyclerview> {
    List<Casttvdone> resultList;
    ...
    public  adaptortvdone(Context context,List<Casttvdone> resultList,int catagory, itemclicklistener listener) {
    ...
    public void onBindViewHolder(@NonNull final viewholderforrecyclerview viewholderforrecyclerview, int i) {
       Casttvdone result=resultList.get( i );
        viewholderforrecyclerview.postername.setText( result.getName() );
