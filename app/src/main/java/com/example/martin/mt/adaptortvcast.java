...
public class adaptortvcast extends RecyclerView.Adapter<viewholdercastmovie> {
    LayoutInflater inflater;
    List<Casttv> castlist;
    Context context;
    itemclicklistener listener;
    View  output;

    public adaptortvcast(Context context,List<Casttv> castlist,  itemclicklistener listener) {
