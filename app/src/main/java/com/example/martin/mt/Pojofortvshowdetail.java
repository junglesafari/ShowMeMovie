...
public class Pojofortvshowdetail {
    ...
    private List<Genretvshow> mGenres;
    ...
    private List<ProductionCompanytvshow> mProductionCompanies;
    ...
    public List<Genretvshow> getGenres() {
        return mGenres;
    }

    public void setGenres(List<Genretvshow> genres) {
        mGenres = genres;
    }
    ...
    public List<ProductionCompanytvshow> getProductionCompanies() {
        return mProductionCompanies;
    }

    public void setProductionCompanies(List<ProductionCompanytvshow> productionCompanies) {
