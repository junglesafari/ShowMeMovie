    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (b != null) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(com.example.martin.mt.R.drawable.ic_menu_gallery, null));
            } else {
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(com.example.martin.mt.R.drawable.ic_menu_gallery));
            }
